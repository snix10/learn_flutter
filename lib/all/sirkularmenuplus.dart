...
class SirkularmenuplusPage extends StatelessWidget {
  final GlobalKey<FabCircularMenuPlusState> fabKey = GlobalKey();

  // SirkularmenuplusPage({Key? key}) : super(key: key);
          ...
          builder: (context) => FabCircularMenuPlus(
            ...
            children: <Widget>[
              ...
              RawMaterialButton(
                onPressed: () {
                  _showSnackBar(context,
                      "You pressed 5. This one closes the menu on tap");
                  fabKey.currentState?.close();
                },
                shape: const CircleBorder(),
                padding: const EdgeInsets.all(24.0),
                child: const Icon(Icons.looks_5, color: Colors.white),
              ),RawMaterialButton(
                onPressed: () {
                  _showSnackBar(context,
                      "You pressed 5. This one closes the menu on tap");
