...
class _MyAppState extends State<SlidingUp> {
            ...
            child: Column(
              children: <Widget>[
                ...
                Flexible(
                  child: Container(
                    padding:
                        EdgeInsets.all(8.0), // Tambahkan padding jika perlu
                    child: GridView.builder(
                      controller: scrollController,
                      physics: ClampingScrollPhysics(),
                      gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                        crossAxisCount: 10, // Jumlah kolom yang diinginkan
                        crossAxisSpacing: 1.0, // Spasi horizontal antar kolom
                        mainAxisSpacing: 1.0, // Spasi vertikal antar baris
                        childAspectRatio:
                            1.0, // Rasio aspek lebar terhadap tinggi
                      ),
                      itemBuilder: (context, index) {
                        return Container(
                          color: const Color.fromARGB(255, 134, 202, 16),
                          child: Center(
                            child: Text(
                              'Item $index',
                              style: TextStyle(
                                  fontSize:
                                      12), // Sesuaikan ukuran teks jika perlu
                            ),
                          ),
                        );
                      },
